...
targets <- read_tsv("C:/R Projects/diy-transcriptomics/diy-transcriptomics/studydesign.txt")# read in your study design
path <- file.path("C:/R Projects/diy-transcriptomics/diy-transcriptomics/read-mapping-with-kallisto", targets$sample, "abundance.h5") # set file paths to your mapped data
